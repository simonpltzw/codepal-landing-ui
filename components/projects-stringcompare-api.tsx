    ...
    return (
        <Card>
            <CardContent className="grid grid-cols-1 sm:grid-cols-5 p-0" style={{minHeight: 250}}>
                <div className="bg-purple-900 text-white col-span-1 sm:col-span-2 h-full p-10 rounded-tl-lg rounded-tr-lg rounded-br-none sm:rounded-tl-none sm:rounded-br-lg flex justify-center items-center order-1 sm:order-2">
                ...
                <div className="col-span-1 sm:col-span-3 h-full p-10 flex flex-col gap-4 order-2 sm:order-1">
                    ...
                    <p>This Web-API offers endpoints to perform operations required to synchronize two texts.</p>
                    <p>The project is written in C# and uses the minimal Web-API approach introduced in dotnet 6.</p>
